...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SDAHymns.Core.Data.Models.AppSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ActiveDisplayProfileId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("AudioAutoPlayDelay")
                        .HasColumnType("INTEGER");

                    b.Property<string>("AudioLibraryPath")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");

                    b.Property<string>("AudioOutputDeviceId")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("LastWindowSize")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ActiveDisplayProfileId");
            ...
            modelBuilder.Entity("SDAHymns.Core.Data.Models.AudioRecording", b =>
                {
                    ...
                    b.Property<string>("TimingMapJson")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SDAHymns.Core.Data.Models.AppSettings", b =>
                {
                    b.HasOne("SDAHymns.Core.Data.Models.DisplayProfile", "ActiveDisplayProfile")
                        .WithMany()
                        .HasForeignKey("ActiveDisplayProfileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ActiveDisplayProfile");
                });
